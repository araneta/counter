...
<header><h2>Langkah 1 - Setting GAMMURC</h2></header>
<div class="module_content">
<?php
$handle = fopen("app/gammu/gammurc", "r");
$baris = array();
$i = 1;
$j = 1;
if ($handle) {
...
if (@$_GET['op'] == "simpan")
{
  ...
  $handle = fopen("app/gammu/gammurc", "w");

  $text = "[gammu]\nport = ".$port1.":\nconnection = ".$connection1."\n[gammu1]\nport = ".$port2.":\nconnection = ".$connection2."\n[gammu2]\nport = ".$port3.":\nconnection = ".$connection3."\n[gammu3]\nport = ".$port4.":\nconnection = ".$connection4;
  
  fwrite($handle, $text);
  fclose($handle); 
  echo "<h4 class='alert_success'>Konfigurasi GAMMURC sudah disimpan</h4>";  
}
...
<form method="post" action="<?php $_SERVER['PHP_SELF']; ?>?page=setting&op=simpan">
<table>
